...
export default function FormLocalizacaoAsyncStorage({ navigation, route }) {
  ...
  function salvar() {
    if (nome === '' || Cpf === '' || Email === '' || Senha === ''|| Telefone === '') {
      ...
      console.log("🚀 ~ file: FormLocalizacaoAsyncStorage.js:51 ~ salvar ~ objetoEmString:", objetoEmString);

      console.log(typeof objetoEmString);

      const objeto = JSON.parse(objetoEmString);
      console.log("🚀 ~ file: FormLocalizacaoAsyncStorage.js:56 ~ salvar ~ objeto:", objeto);
